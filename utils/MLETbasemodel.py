...
class Linear(nn.Module):
    def __init__(self, feature_columns, feature_index, init_std=0.0001, device='cpu'):
        ...
        self.embedding_dict = create_embedding_matrix(feature_columns, init_std, linear=True, sparse=True,
                                                      device=device,inner_dim=None)
...
class BaseModel(nn.Module):
    def __init__(self,
                 ...
                 task='binary', device='cpu',embd_inner_dim=None):
        ...
        self.embedding_dict = create_embedding_matrix(dnn_feature_columns, init_std, sparse=True, device=device,inner_dim=embd_inner_dim)
        #         nn.ModuleDict(
    ...
    def fit(self, x=None,
            ...
            shuffle=True,
            use_double=False,amp_enable=False):
        """
        ...
        """
        if amp_enable:
            print('fit function: amp enabled')
        ...
        # reduce memory from fp64 to fp32
        y = y.astype('float32')
