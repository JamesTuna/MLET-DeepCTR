...
print('Training DeepFM model with inner dim: %s...'%(INNER_DIM))
model = DeepFM(linear_feature_columns=linear_feature_columns, dnn_feature_columns=dnn_feature_columns,task='binary',l2_reg_embedding=1e-5, device=device, embd_inner_dim = INNER_DIM)
